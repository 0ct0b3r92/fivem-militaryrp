...
-- Dumping data for table essentialmode.characters: ~4 rows (approximately)
...
-- Dumping data for table essentialmode.jobs: ~5 rows (approximately)
...
INSERT IGNORE INTO `jobs` (`id`, `name`, `label`, `whitelisted`) VALUES
	...
	(3, 'russianfederationarmy', 'United Kingdom Army', 0),
...
-- Dumping data for table essentialmode.job_grades: ~17 rows (approximately)
